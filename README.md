...
~~~sh
# getting the code
git clone git@github.com:nko4/seven-digital.git && cd ./seven-digital/

# developing
npm install
npm start

# deploying (to http://seven-digital.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@seven-digital.2013.nodeknockout.com
ssh root@seven-digital.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@seven-digital.2013.nodeknockout.com
ssh -i ./id_deploy root@seven-digital.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/seven-digital" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
